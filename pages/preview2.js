...
const preview2 = () => {
    ...
    useEffect(() => {
        ...
        const loadData = async () => {
            ...
            menu.current = ord1.data.length + ord2.data.length
            ...
            <div ref={componentRef}>
                ...
                <table className="table table-striped mx-auto bordered" style={{width: '85%'}}>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colSpan={3} className='text-center' style={{borderLeft: '1px solid black', borderRight: '1px solid black', borderBottom: '1px solid black'}}><h5>{'สั่งสินค้ารวม ' + order.length + ' ชนิดสินค้า ' + menu.current + ' รายการ'}</h5></td>
                        </tr>
                    </tbody>
                </table>
            </div>
